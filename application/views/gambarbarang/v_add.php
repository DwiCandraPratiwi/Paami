                ...
                echo form_open_multipart('gambarbarang/add/'. $barang->id_barang);?>
                  ...
                  <div class="row">
                    <div class="col-sm-4">
                      ...
                      <input name="ket" class="form-control" placeholder="Ket Barang" value="<?= set_value('ket')?>">
                    </div>
                    <div class="col-sm-4">
                    ...
                    <div class="col-sm-4">
                    <div class="form-group">
                      <img src="<?=base_url('assets/gambar/no-foto.jpg')?>" id="gambar_nodin"width="200px">
                     </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <?php foreach ($gambar as $key => $value) { ?>
                      <div class="col-sm-3">
                        <div class="form-group">
                          <img src="<?=base_url('assets/gambarbarang/'. $value->gambar)?>" id="gambar_nodin"width="200px" height="200px">
                        </div>
                        <label for="">Ket : <?= $value->ket?></label>
                        <button class="btn btn-danger btn-xs btn-block" data-toggle="modal" data-target="#delete<?=$value->id_gambar ?>"><i class="fas fa-trash"></i>Hapus</button>
                      </div>
                    <?php }  ?>
                  </div>
              </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <h5>Apakah Anda Yakin Menghapus Gambar Ini...?</h5>
     ...
     function bacaGambar(input){
       if (input.files && input.files[0]){
         ...
         reader.onload=function(e){
           $('#gambar_nodin').attr('scr', e.target.result);
         }
