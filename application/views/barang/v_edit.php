            ...
            <div class="card-header">
              ...
              <div class="row">
                 ...
                 <div class="form-group">
                        ...
                        <textarea name="deskripsi" class="form-control" rows="5"placeholder="Deskripsi"><?= $barang->deskripsi?></textarea>
                      </div>
                    <div class="row">
                      <div class="col-sm-6">
                      <div class="form-group">
                      ...
                      <div class="col-sm-6">
                      <div class="form-group">
                        <img src="<?=base_url('assets/gambar/'.$barang->gambar)?>" id="gambar_nodin"width="270px">
                       </div>
                      </div>
                    </div>
                      <div class="form-group">
